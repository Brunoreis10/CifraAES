...
public class AESUtils {
    ...
    public static final int[][] tabelaE = {{0x01, 0x03, 0x05, 0x0f, 0x11, 0x33, 0x55, 0xff, 0x1a, 0x2e, 0x72, 0x96, 0xa1, 0xf8, 0x13, 0x35},
    ...
    public static final int[][] tabelaL = {{0x00, 0x00, 0x19, 0x01, 0x32, 0x02, 0x1a, 0xc6, 0x4b, 0xc7, 0x1b, 0x68, 0x33, 0xee, 0xdf, 0x03},
    ...
    public String decodificarBinaryToText(String texto) {
        StringBuilder builder = new StringBuilder();
        for (String bin : texto.split(" ")) {
            final int charCode = Integer.parseInt(bin.trim(), 2);
            builder.append(new Character((char) charCode).toString());
        }

        return builder.toString();
    }

    public byte[] decodificarFileToBase64Binary(String textoString) {
        byte[] decodedFile = null;
        decodedFile = Base64.getDecoder().decode(textoString);

        return decodedFile;
    }

    public static String getHexByByte(byte[] bytes) {
        StringBuilder builder = new StringBuilder();
    ...
    public static byte[] getByteByString(String texto) {
        return new BigInteger(texto, 16).toByteArray();
    }

    public Integer getSBoxByLinhaEColuna(Integer linha, Integer coluna) {
