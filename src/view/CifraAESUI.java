...
public class CifraAESUI extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel4.setText("*Chave tem que ser do tipo Inteiro.");
    ...
    private void executarbtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_executarbtnActionPerformed
        if (!chaveArea.getText().trim().equals("")
            ...
            String[] chave = chaveArea.getText().replace(" ","").split(",");
            for(int i=0;i<16;i++){
                chave[i] = Integer.toHexString(Integer.parseInt(chave[i]));
            }            
            List<RoundKey> listRoundKeys = exec.executarRotinas(chave);
